...
import type { ExternalBlob as _ExternalBlob, PrivatePropertyListing as _PrivatePropertyListing, PublicPropertyListing as _PublicPropertyListing, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createOrUpdateProperty(arg0: string, arg1: PrivatePropertyListing): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createOrUpdateProperty(arg0, await to_candid_PrivatePropertyListing_n10(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllPaymentRecords(): Promise<Array<[Principal, Array<PaymentRecord>]>> {
        if (this.processError) {
            try {
    ...
    async getPropertyDetails(arg0: string): Promise<PrivatePropertyListing> {
        if (this.processError) {
            try {
                const result = await this.actor.getPropertyDetails(arg0);
                return from_candid_PrivatePropertyListing_n17(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getPublicProperties(): Promise<Array<PublicPropertyListing>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPublicProperties();
    ...
    async submitPayment(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
...
async function from_candid_PrivatePropertyListing_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PrivatePropertyListing): Promise<PrivatePropertyListing> {
    return await from_candid_record_n18(_uploadFile, _downloadFile, value);
}
async function from_candid_PublicPropertyListing_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PublicPropertyListing): Promise<PublicPropertyListing> {
...
async function from_candid_vec_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PublicPropertyListing>): Promise<Array<PublicPropertyListing>> {
    return await Promise.all(value.map(async (x)=>await from_candid_PublicPropertyListing_n22(_uploadFile, _downloadFile, x)));
}
...
async function to_candid_PrivatePropertyListing_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: PrivatePropertyListing): Promise<_PrivatePropertyListing> {
...
async function to_candid_record_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        areaName: value.areaName,
        fullAddress: value.fullAddress,
        photos: await to_candid_vec_n12(_uploadFile, _downloadFile, value.photos)
    };
}
