...
export interface _SERVICE {
  ...
  'createOrUpdateProperty' : ActorMethod<
    [string, PrivatePropertyListing],
    undefined
  >,
  ...
  'getPropertyDetails' : ActorMethod<[string], PrivatePropertyListing>,
  'getPublicProperties' : ActorMethod<[], Array<PublicPropertyListing>>,
  'getUserProfile' : ActorMethod<[Principal], [] | [UserProfile]>,
  'isCallerAdmin' : ActorMethod<[], boolean>,
  'saveCallerUserProfile' : ActorMethod<[UserProfile], undefined>,
  'submitPayment' : ActorMethod<[string, string], undefined>,
}
